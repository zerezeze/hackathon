...
showRegistrationFormBtn.addEventListener("click", () =>
    ...
    .forEach((monitor) => {
      ...
      li.innerHTML = `
            ...
            <div class="monitor-actions">
                ...
                <button class="contactBtn" data-id="${monitor.id}">Contatar via WhatsApp</button>
            </div>
        `;
...
function handleContactFormSubmission(e) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Olá ${monitor.name}, meu nome é ${studentName}. ${message}`,
  );
